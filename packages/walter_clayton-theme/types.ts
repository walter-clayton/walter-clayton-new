 ...
 */
interface WalterClaytonTheme extends Package {
  /**
  ...
  actions: {
    ...
    theme: {
       ...
       */
      toggleMobileMenu: Action<WalterClaytonTheme>;

      /**
       * Closes the mobile menu, not matter the previous state.
       */
      closeMobileMenu: Action<WalterClaytonTheme>;
    };
  };
...
export default WalterClaytonTheme;
