            ...
            <JumbotronContainer>
                <Block>
                    ...
                    {isHomePage ? (
                        <>
                        <Title>Home</Title>
                        <SubTitle>Discover my blog posts</SubTitle>
                        </>
                    ) : (
                        <>
                        <Title>Portfolio</Title>
                        <SubTitle>Discover the code and live demos</SubTitle>
                        </>
                    )}
                    </>            
                </Block>
                <Block>
                    <svg width="100%" height="100%" viewBox="0 0 406 306" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <AppearOne opacity="0.52" d="M90.7629 140.758H173.026C178.075 140.758 182.167 136.665 182.167 131.617V39.0387C182.167 33.9906 178.075 29.8983 173.026 29.8983L90.7629 29.8983C85.7148 29.8983 81.6225 33.9906 81.6225 39.0387L81.6225 131.617C81.6225 136.665 85.7148 140.758 90.7629 140.758Z" fill="#F9AA8F" />
                        <AppearOne d="M90.7629 140.758H173.026C178.075 140.758 182.167 136.665 182.167 131.617V39.0387C182.167 33.9906 178.075 29.8983 173.026 29.8983L90.7629 29.8983C85.7148 29.8983 81.6225 33.9906 81.6225 39.0387L81.6225 131.617C81.6225 136.665 85.7148 140.758 90.7629 140.758Z" fill="url(#paint0_linear)" />
                        <AppearTwo opacity="0.52" d="M248.913 119.375L343.238 119.375C348.045 119.375 351.942 115.478 351.942 110.671V59.5556C351.942 54.7487 348.045 50.8519 343.238 50.8519L248.913 50.8519C244.106 50.8519 240.209 54.7487 240.209 59.5556V110.671C240.209 115.478 244.106 119.375 248.913 119.375Z" fill="#F9AA8F" />
                        <AppearTwo d="M248.913 119.375L343.238 119.375C348.045 119.375 351.942 115.478 351.942 110.671V59.5556C351.942 54.7487 348.045 50.8519 343.238 50.8519L248.913 50.8519C244.106 50.8519 240.209 54.7487 240.209 59.5556V110.671C240.209 115.478 244.106 119.375 248.913 119.375Z" fill="url(#paint1_linear)" />
                        <AppearThree opacity="0.52" d="M220.069 69.321L279.331 69.321C282.349 69.321 284.797 66.8738 284.797 63.8549V31.7355C284.797 28.7166 282.349 26.2693 279.331 26.2693L220.069 26.2693C217.05 26.2693 214.602 28.7166 214.602 31.7355V63.8549C214.602 66.8738 217.05 69.321 220.069 69.321Z" fill="#F9AA8F" />
                        <path opacity="0.52" d="M125.721 200.411L295.646 200.411V192.265L125.721 192.265V200.411Z" fill="#F9AA8F" />
                        <path d="M158.887 181.784L270.04 181.784C275.262 181.784 279.496 177.55 279.496 172.327V95.2212C279.496 89.9985 275.262 85.7646 270.04 85.7646L158.887 85.7646C153.664 85.7646 149.43 89.9985 149.43 95.2212V172.327C149.43 177.55 153.664 181.784 158.887 181.784Z" fill="#F9AA8F" />
                        <path d="M158.887 181.784L270.04 181.784C275.262 181.784 279.496 177.55 279.496 172.327V95.2212C279.496 89.9985 275.262 85.7646 270.04 85.7646L158.887 85.7646C153.664 85.7646 149.43 89.9985 149.43 95.2212V172.327C149.43 177.55 153.664 181.784 158.887 181.784Z" fill="url(#paint3_linear)" />
                        <ScreenWritingScroll>
                            <path className="writing-first-1" d="M191.36 100.8H165.422V102.705H191.36V100.8Z" fill="url(#paint4_linear)" />
                            <path className="writing-first-2" d="M181.256 104.482H165.422V106.267H181.256V104.482Z" fill="url(#paint5_linear)" />
                            <path className="writing-first-3" d="M237.461 104.482H187.641V106.282H237.461V104.482Z" fill="url(#paint6_linear)" />
                            <path className="writing-first-4" d="M270.16 104.482H242.121V106.282H270.16V104.482Z" fill="url(#paint7_linear)" />
                            <path className="writing-first-5" d="M195.426 108.179H173.659V110.061H195.426V108.179Z" fill="url(#paint8_linear)" />
                            <path className="writing-first-6" d="M206.584 111.853H180.646V113.758H206.584V111.853Z" fill="url(#paint9_linear)" />
                            <path className="writing-first-7" d="M230.022 111.853H208.278V113.969H230.022V111.853Z" fill="url(#paint10_linear)" />
                            <path className="writing-first-8" d="M200.636 115.535H180.608V117.319H200.636V115.535Z" fill="url(#paint11_linear)" />
                            <path className="writing-first-9" d="M243.891 115.535H202.556V117.515H243.891V115.535Z" fill="url(#paint12_linear)" />
                            <path className="writing-first-10" d="M191.36 120.519H165.422V122.424H191.36V120.519Z" fill="url(#paint13_linear)" />
                            <path className="writing-first-11" d="M181.256 124.201H165.422V125.985H181.256V124.201Z" fill="url(#paint14_linear)" />
                            <path className="writing-first-12" d="M237.461 124.201H187.641V126H237.461V124.201Z" fill="url(#paint15_linear)" />
                            <path className="writing-first-13" d="M270.16 124.201H242.121V126H270.16V124.201Z" fill="url(#paint16_linear)" />
                            <path className="writing-first-14" d="M195.426 127.883H173.659V129.765H195.426V127.883Z" fill="url(#paint17_linear)" />
                            <path className="writing-first-15" d="M206.584 131.572H180.646V133.477H206.584V131.572Z" fill="url(#paint18_linear)" />
                            <path className="writing-first-16" d="M230.022 131.572H208.278V133.688H230.022V131.572Z" fill="url(#paint19_linear)" />
                            <path className="writing-first-17" d="M200.636 135.254H180.608V137.038H200.636V135.254Z" fill="url(#paint20_linear)" />
                            <path className="writing-first-18" d="M243.891 135.254H202.556V137.234H243.891V135.254Z" fill="url(#paint21_linear)" />
                            <path className="writing-first-19" d="M191.36 140.23H165.422V142.135H191.36V140.23Z" fill="url(#paint22_linear)" />
                            <path className="writing-first-20" d="M181.256 143.912H165.422V145.697H181.256V143.912Z" fill="url(#paint23_linear)" />
                            <path className="writing-first-21" d="M237.461 143.912H187.641V145.712H237.461V143.912Z" fill="url(#paint24_linear)" />
                            <path className="writing-first-22" d="M270.16 143.912H242.121V145.712H270.16V143.912Z" fill="url(#paint25_linear)" />
                            <path className="writing-first-23" d="M195.426 147.594H173.659V149.476H195.426V147.594Z" fill="url(#paint26_linear)" />
                            <path className="writing-first-25" d="M230.022 151.276H208.278V153.392H230.022V151.276Z" fill="url(#paint28_linear)" />
                            <path className="writing-first-26" d="M200.636 154.965H180.608V156.749H200.636V154.965Z" fill="url(#paint29_linear)" />
                            <path className="writing-first-27" d="M243.891 154.965H202.556V156.945H243.891V154.965Z" fill="url(#paint30_linear)" />
                        </ScreenWritingScroll>
                        ...
                        <AppearFive d="M278.465 176.371H326.026C330.609 176.371 334.323 172.656 334.323 168.073V137.091C334.323 132.509 330.609 128.794 326.026 128.794H278.465C273.882 128.794 270.168 132.509 270.168 137.091V168.073C270.168 172.656 273.882 176.371 278.465 176.371Z" fill="white" />
                        <AppearFour d="M92.3817 180.308H150.078C154.514 180.308 158.111 176.712 158.111 172.275V161.282C158.111 156.845 154.514 153.249 150.078 153.249H92.3817C87.9448 153.249 84.3481 156.845 84.3481 161.282V172.275C84.3481 176.712 87.9448 180.308 92.3817 180.308Z" fill="white" />
                        ...
                        <defs>
                            <linearGradient id="paint0_linear" x1="133.288" y1="116.205" x2="127.987" y2="-1.07668" gradientUnits="userSpaceOnUse">
                            ...
                            <linearGradient id="paint3_linear" x1="40719.7" y1="25064.2" x2="40053.4" y2="5384.52" gradientUnits="userSpaceOnUse">
                                <stop offset="0.95" stopColor="white" />
                                <stop offset="1" stopColor="#F9AA8F" />
                            </linearGradient>
                            <linearGradient id="paint4_linear" x1="179.381" y1="49.2105" x2="177.951" y2="125.496" gradientUnits="userSpaceOnUse">
                                <stop stopColor="white" stopOpacity="0" />
                            ...
                            <linearGradient id="paint32_linear" x1="3587.67" y1="3957.21" x2="3803.33" y2="3957.21" gradientUnits="userSpaceOnUse">
                                <stop offset="0.9998" stopColor="#EAD4D0" />
                                <stop offset="0.9999" stopColor="#E5C6D6" />
                                <stop offset="1" stopColor="#F0E9CB" />
                            </linearGradient>
